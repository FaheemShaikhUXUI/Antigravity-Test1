...
// 1. Read the original pristine CSS
const pristineCSS = fs.readFileSync(pristineCssPath, 'utf8');

// 2. Define our custom overrides
const customCSS = `
...
.main-content {
  ...
  height: 100%;
  padding-right: 40px !important; /* Ensure minimum 30px gap for content tiles */
}
...
console.log('Successfully rebuilt globals.css from the pristine legacy CSS!');
