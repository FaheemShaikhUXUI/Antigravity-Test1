...
const replacements = [
  { match: /<button class="nav-tab active" data-tab="logo-color">Logo & Color<\\/button>/, replace: '<button class="nav-tab active" data-tab="logo-color">' + svgs.logoColor + ' Logo & Color</button>' },
  { match: /<button class="nav-tab" data-tab="typography">Typography<\\/button>/, replace: '<button class="nav-tab" data-tab="typography">' + svgs.typography + ' Typography</button>' },
  { match: /<button class="nav-tab" data-tab="letterhead">Letterhead<\\/button>/, replace: '<button class="nav-tab" data-tab="letterhead">' + svgs.letterhead + ' Letterhead</button>' },
  { match: /<button class="nav-tab" data-tab="presentation">Presentation<\\/button>/, replace: '<button class="nav-tab" data-tab="presentation">' + svgs.presentation + ' Presentation</button>' },
  { match: /<button class="nav-tab" data-tab="digital-assets">Digital<\\/button>/, replace: '<button class="nav-tab" data-tab="digital-assets">' + svgs.digital + ' Digital</button>' },
  { match: /<button class="nav-tab" data-tab="print-assets">Print<\\/button>/, replace: '<button class="nav-tab" data-tab="print-assets">' + svgs.print + ' Print</button>' },
  { match: /<button class="nav-tab" data-tab="vehicle-branding">Vehicle<\\/button>/, replace: '<button class="nav-tab" data-tab="vehicle-branding">' + svgs.vehicle + ' Vehicle</button>' },
  { match: /<button class="nav-tab" data-tab="charger-branding">Charger<\\/button>/, replace: '<button class="nav-tab" data-tab="charger-branding">' + svgs.charger + ' Charger</button>' },
  { match: /<button class="nav-tab" data-tab="brand-philosophy">Brand Philosophy<\\/button>/, replace: '<button class="nav-tab" data-tab="brand-philosophy">' + svgs.philosophy + ' Brand Philosophy</button>' },
  { match: /<button class="nav-tab" data-tab="photos">Photos<\\/button>/, replace: '<button class="nav-tab" data-tab="photos">' + svgs.photos + ' Photos</button>' }
];
...
console.log('Successfully injected SVGs into sidebar menus!');
